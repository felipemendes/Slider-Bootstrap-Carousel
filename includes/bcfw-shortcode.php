...
function bcfw_slider_bootstrap_carousel_function( $atts )
{
	...
	<div id="slider-bootstrap-carousel" class="carousel slide" data-ride="carousel">
		...
		<a class="left carousel-control" href="#slider-bootstrap-carousel" data-slide="prev">
			<span class="glyphicon glyphicon-chevron-left"></span>
			<span class="sr-only">Previous</span>
		</a>
		<a class="right carousel-control" href="#slider-bootstrap-carousel" data-slide="next">
