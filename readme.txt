...
3. Display Shortcode [slider_bootstrap_carousel] or [slider_bootstrap_carousel category='your_category_slug']. To display on code do_shortcode("[slider_bootstrap_carousel]")